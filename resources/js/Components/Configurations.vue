...
let form = useForm({
  dialog: false,
  notifications: [],
  notifications_not_available: false,
...
if (browserInfo.includes('Opera') || browserInfo.includes('Opr') || browserInfo.includes('Edg') || browserInfo.includes('Chrome') || browserInfo.includes('Firefox')) {
  ...
  form.notifications_not_available = true;
}
  ...
  >
    ...
    <v-card>
      ...
      <v-list lines="two" density="compact">
        ...
        <v-list-item :title="$t('message.subscribe_st_petersburg_pd')" :subtitle="$t('message.receive_messages')" v-if="!form.notifications_not_available">
        ...
        <v-list-item :title="$t('message.subscribe_orlando_pd')" :subtitle="$t('message.receive_messages')" v-if="!form.notifications_not_available">
          <template v-slot:prepend>
            <v-checkbox
                v-model="form.notifications"
                color="primary"
        ...
        <v-list-item v-if="form.notifications_not_available">
          This feature is not available on mobile devices at this time. Try it on your laptop!
        </v-list-item>
      </v-list>
      <v-divider></v-divider>
      <v-spacer></v-spacer>
