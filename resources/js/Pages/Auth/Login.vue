        ...
        <v-main>
            <div class="flex min-h-dvh flex-col justify-center px-6 py-12 lg:px-8 bg-[#fbf2fe]">
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <h2 class="mt-10 text-center text-2xl font-semibold leading-9 tracking-tight text-gray-900">Sign in
                        to your account</h2>
                </div>
                ...
                <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form @submit.prevent="submit">
                        ...
                        <div class="mt-2">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-sm">
                                    <Link :href="route('password.request')" class="font-semibold text-purple-600 hover:text-purple-500">Forgot
                                        password?
                                    </Link>
                                </div>
                            </div>
                    ...
                    <p class="mt-10 text-center text-sm text-gray-500">
                        Not a member?
                        <Link :href="route('register')" class="font-semibold text-purple-600 hover:text-purple-500">Sign up now!</Link>
                    </p>
                </div>
            </div>
        </v-main>
